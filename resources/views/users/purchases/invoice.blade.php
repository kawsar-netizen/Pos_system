...
<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-md-5 text-left">
                                        <div> <strong>Supllier :</strong> {{$user->name}}</div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->total}}</td>
                                                <td class="text-right">
                                                <form action="{{route('user.purchases.invoice.deleteItem',['id' => $user->id,'invoice_id'=>$invoice->id,'item_id'=>$item->id])}}" method="post">
                                                @csrf
                                                      @method('DELETE')
        ...
        <div class="modal fade" id="newProduct" tabindex="-1" role="dialog"aria-labelledby="newProductModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            {!! Form::open([ 'route' => ['user.purchases.invoice.addItems', $user->id,$invoice->id], 'method' => 'post' ]) !!}
  ...
  <!-- Add a new Receipt Modal -->
        ...
        <div class="modal fade" id="newReceiptInvoice" tabindex="-1" role="dialog"aria-labelledby="newReceiptInvoiceModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="newReceiptInvoiceModalLabel"> New Payments For This Invoice </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
